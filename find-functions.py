...
def findFunctions(path):
  ...
  with open(path, 'r') as file:
    while True:
      ...
      known = []
      ### My own functions
      known.extend([ "RFTrace", "RFInfo", "RFDebug", "RFWarn", "RFError", "RFNFTrace", "inStringRandom", "RFGetSetting", "objToString", "RFConfigDefault", "RFConfigCheckLocalStorage", "RavagerFrameworkPushToLogBuffer", "RFDebugEnabled", "RavagerFrameworkToggleDebug", "RavagerFrameworkRefreshEnemies", "RavagerFrameworkApplySomeSpice", "RavagerFrameworkApplySlimeRestrictChance", "RefreshRavagerDataVariables", "RavagerFrameworkRefreshFonts", "RavagerFrameworkIWantToHelpDebug", "RavagerFrameworkSettingsRefresh", "RavagerFrameworkSetupSound", "bypassed", "experiencedTextDecideDefault", "experiencedTextDecideUser", "experiencedTextDecideRavager", "increasePlayerRavagedCount", "RavagerFreeAndClearAllData", "RavagerFreeAndClearAllDataIfNoRavagers", "RFAddCallback", "RFPushEnemiesWithStrongVariations", "DrawCheckboxRFEx", "RFAddTextKey", "RFArrayRand", "RFGetRestraint", "RFGetText", "RFStringFormat", "RavagerFrameworkGetFunctionOverrides", "RavagerFrameworkSetMimicExposure", "RavagerFrameworkSetMimicPassive", "RavagerFrameworkSetMimicTracking", "RavagerFrameworkSetRavagerCounting", "LoadTranslations" ])
      ### Built in JS object functions
      known.extend([ "replace", "substring", "split", "floor", "replaceAt", "slice", "push", "pop", "filter", "max", "eval", "createElement", "translate", "appendChild", "addEventListener", "parse", "find", "structuredClone", "Error", "substr", "log", "warn", "error", "trim", "toString", "Boolean", "get", "isArray", "hasOwnProperty", "has", "splice", "match", "stringify", "Date", "setAttribute", "click", "removeChild", "FontFace", "add", "load", "delete", "findIndex", "some", "keys", "includes", "random", "Number", "findLast", "setTimeout", "min", "assign", "Set", "URL.revokeObjectURL", "text", "forEach", "indexOf", "fetch", "text", "function", "toUpperCase", "parseFloat", "readAsText", "blob" ])
      ### Custom object functions that I created
      known.extend([ "block", "getval", "postclick" ])
