...
KDModelDresses['BanditRavDresses'] = [
	{
...
KDModelCosplay['BanditRavCosplay'] = [
	{
    "Item": "RavLargeHeartHairpin",
    "Group": "Hair",
    "Parent": "HeartHairPins",
  ...
  },
  {
    ...
    "Layers": {
      ...
      "BackShortCurlyUnderlight": {
        "Name": "BackShortCurlyUnderlight",
        "Layer": "HairBack",
        "Pri": -0.1,
        "NoOverride": true,
        "TieToLayer": "BackShortCurly"
      }
    },
    "Filters": {
      "BackShortCurly": {
...
KDModelFace['BanditRavFace'] = [
    ...
    "Filters": {
      "Eyes": {
        ...
        "saturation": 0.016666666666666666,
        "contrast": 1,
        "brightness": 1.1166666666666667,
        "red": 1.6166666666666665,
        "green": 0.8333333333333333,
        "blue": 0.7166666666666667,
        "alpha": 1
      },
      "Eyes2": {
        "gamma": 0.5333333333333333,
...
KDModelStyles['BanditRavStyle'] = {
	Cosplay: [ 'BanditRavCosplay' ],
	Hairstyle: [ 'BanditRavHair' ],
	Bodystyle: [ 'BanditRavBody' ],
	Facestyle: [ 'BanditRavFace' ],
}

let banditRavager = {
	style: 'BanditRavStyle', // Body style
	outfit: 'BanditRavDresses', // Outfit style
