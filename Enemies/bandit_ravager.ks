...
let banditRavager = {
	...
	armor: 1.5, 
	maxhp: 12, 
	minLevel: 1, // This affects the earliest floor they can spawn on
	weight: 6,
	visionRadius: 7, 
	movePoints: 3,
	// Main attack
	...
	dmgType: "grope",
	attack: "MeleeEffectBlind", // "MeleeEffect" is the main attack type, but as long as attack has "Effect", the ravaging effect can be done
	attackLock: "White",
	power: 2, // I don't think this actually does anything with this enemy's setup; in theory, affects how strong their hits are -- This being 20, plus the imprisonable tag, allowed the bandit rav to be found in Fuuka's prison and recruited as a overly powerful ally
	...
	disarm: 0.2,
	hitsfx: "Grab",
	// Spawning/drops, currently just drops money
	...
	*/
	...
	// On-hit effects this enemy should use; the "Ravage" effect is required for ravaging
	effect: {
		effect: {
			name: "Ravage"
		}
	},
	// "ravagerRemove" is required to make sure ravaging data is cleared properly when finishing/breaking free
	// "ravagerRefractory" is required to handle the refractory period after finishing; without this event, a ravager would ravage once and never again
	events: [
		{trigger: "death", type: "ravagerRemove"},
		{trigger: "tickAfter", type: "ravagerRefractory"},
	],
	// Useful flags
	noDisplace: true, // Theoretically stops enemies from shoving this one out of the way. Didn't seem to work by its lonesome for me; more testing needed
