...
KinkyDungeonRestraints.push(
  ...
  },
  {
    ...
    escapeChance: { "Remove": 2, "Struggle": 2 },
    playerTags: { "ItemArmsFull": 6 },
    addTag: [ "stripped", "strippedBreasts" ],
    enemyTags: {},
    minLevel: 0,
    allFloors: true,
    removeOnLeash: false,
    ...
    shrine: [],
    events: [
      { trigger: "postRemoval", type: "RFStripBreast" },
    ],
    failSuffix: { "Remove": "RavagerStrippedBreast", "Struggle": "RavagerStrippedBreast" },
    customEquip: "RavagerStrippedBreast",
    customEscapeSucc: "RavagerStrippedBreast",
  },
